...
RUN ~/miniconda3/condabin/conda install --yes -c mrtrix3 mrtrix3 -n dMRI
...
# same for libarchive.so.19
# RUN ln -s /root/miniconda3/lib/libarchive.so.13.6.2 /root/miniconda3/lib/libarchive.so.19
