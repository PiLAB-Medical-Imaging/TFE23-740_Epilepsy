...
\end{figure}
  ...
  \subsection*{The Vagus Afferent Network}
    ...
    Significantly greater FA was observed in VNS (lateralized to the left) responders particularly within anterior and retrolenticular limbs of the internal capsule, anterior, superior and posterior corona radiata, and posterior thalamic radiation. % qua mettere una foto per fa capire cos'é il posterior thalamic radiation.
    ...
    %% TODO magari aggiungere una sezione che parla dell Hemispheric Association Fibers [Mithani2019]
